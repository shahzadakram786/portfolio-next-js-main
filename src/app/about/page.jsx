              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">
                    Senior Front end develoepr
                  </div>
                  {/* job desc  */}
                  <div className="p-3 text-sm italic">
                    MY current employment. Way better than the possition before!
                  </div>
                  {/* job Data  */}
                  <div className="p-3 text-red-300 font-semibold text-sm">
                    2023 - present
                  </div>
                  {/* job compnay  */}
                  <div className="bg-white p-1 text-sm font-semibold w-fit">
                    WEBLOOP
                  </div>
                </div>
                {/* center  */}
                <div className="w-1/6 ">
                  ...
                  <div className=" w-1 h-full bg-gray-600 rounded relative">
                    {/* line circle  */}
                    <div className=" -left-2 absolute w-5 h-5 rounded-full ring-red-400 bg-white">
                      {" "}
                    </div>
                  </div>
                </div>
